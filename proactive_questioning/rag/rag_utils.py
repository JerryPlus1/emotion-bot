...
# 注意：rag_utils.py 现在在 proactive_questioning/rag/ 目录下
TRAIN_MODEL_DIR = Path(__file__).parent.parent.parent / "train_model"
if TRAIN_MODEL_DIR.exists():
    sys.path.insert(0, str(TRAIN_MODEL_DIR))

# RAG 配置
# 向上两级回到 proactive_questioning 目录
SCRIPT_BASE_DIR = Path(__file__).parent.parent
RAG_KB_DIR = SCRIPT_BASE_DIR / "rag_knowledge_base"
EXTERNAL_KB_DIR = SCRIPT_BASE_DIR / "external_knowledge_base"
